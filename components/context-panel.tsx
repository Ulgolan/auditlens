...
export function ContextPanel({
  ...
  return (
    ...
    <div className="pt-1 pb-4 mb-5 border-b border-border">
      ...
      <div className="mb-2.5">
        ...
        {concept && (
          <div className="px-3.5 py-2.5 rounded-lg bg-card border border-border">
            <div className="font-mono text-[0.75rem] font-medium uppercase tracking-[0.16em] text-text-tertiary mb-1.5">
            ...
            {isLong && (
              <button
                ...
                className="mt-1.5 text-[14px] font-semibold text-navy hover:opacity-70 cursor-pointer transition-opacity"
              >
      ...
      {taskScenario && (
        <div className="mt-2 text-[14px] text-text-secondary leading-relaxed">
